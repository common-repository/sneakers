 ...
 * Plugin URI: https://wordpress.org/plugins/sneakers/
...
function sneakers_style() {
	wp_enqueue_style( 'sneakers-stlye', SNEAKERS_URL. '/css/sneakers.css' );
}
